...
import chess.domain.command.exceptions.CommandTypeException;
import chess.domain.command.exceptions.MoveCommandTokensException;
import chess.domain.coordinate.exceptions.CoordinateException;
...
public class ChessRoomController {
	...
	private static final String PATH = "/woowacourse/chess/rooms/:id";
	private static final String STATIC_PATH = "/woowacourse.chess.html";
